...
//               <input type='text' id='brandName' placeholder='Enter the brand name '
//               name='brandName'
...
//                                   <img src={el}
//                               alt={el}
//                                width={80} height={80} className='b-g-slate-100 border cursor-pointer' onClick={()=>{
...
//                onChange={handleOnChange}
//                className='p-2 bg-slate-100 rounded'/>
//                <label htmlFor='description' className='mt-3'>Description of the Product</label>
//                <textarea className='h-28 bg-slate-100 border resize-none p-1' placeholder='Enter the product description here: ' rows={3}
//                onChange={handleOnChange}
//                name='description'
